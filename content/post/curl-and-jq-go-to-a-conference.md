...
I will use a Web API as an example project, and since I'll be using curl live to query it, I'll need to pipe responses through [jq](https://jqlang.org) to obtain nicely formatted JSON for the audience. 
